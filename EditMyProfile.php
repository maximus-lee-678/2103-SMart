    ...
    <body>
        ...
        <section class="contact" style="margin-bottom: 20px;">
            ...
            <div class="tab">
                ...
                <button class="tablinks" onclick="openCity(event, 'editaccount')">Edit Address</button>
            ...
            <div id="myprofile" class="tabcontent">
                <div class="row">
                    ...
                    <form action="process_editmyaccount.php" class="register-form" method="post" name="myUserProfileForm" style="">
                        ...
                        <div style="margin-bottom: 15px;">
                            ...
                            <div class="inputBox">
                                <input required="true" style="width: 98%" id="user_fullname" name="user_fullname" type="text" class="box">
                            </div>
                        </div>
                        ...
                        <div style="margin-bottom: 15px;">
                            ...
                            <div class="inputBox">
                                <input required="true" style="width: 49%" id="user_phonenum" name="user_phonenum" type="text" class="box">
                                <input required="true" style="width: 49%" id="user_email" name="user_email" type="email" class="box">
                            </div>
                        </div>
                        ...
                        <div style="margin-bottom: 15px;">
                            ...
                            <div class="inputBox">
                                <input required="true" style="width: 59%" id="user_address1" name="user_address1" type="text" class="box">
                                <input required="true" style="width: 39%" id="user_postalcode1" name="user_postalcode1" type="text" class="box">
                            </div>
                        </div>


                        <div class="inputBox">
                            <input type="submit" style="width: 98%" name="updatemyprofile" value="Update My Profile" class="btn">
                        </div>

                        <div class="inputBox">
                            <input type="submit" style="width: 98%" name="cancel" value="Cancel" class="btn">
                        </div>
