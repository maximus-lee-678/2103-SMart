                    ...
                    <div class="panel" style="font-size: 1.4rem;">     
                        <section class ="products">
                            <div class="box-container" id = "product-list">
                                <?php
                                $query = "SELECT * FROM Product_Test WHERE MATCH(name) AGAINST (? IN NATURAL LANGUAGE MODE) ORDER BY RAND() LIMIT 5;";
                                $result = payload_deliver($conn, $query, "s", $params = array("Fettuccine"));
